...
public class MainPKDDJ_MultipleParameters_ConstrainedCocktailParty
{
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        for (String aaa:queryNodesNumber)
        {
            ...
            Map<Integer, List<Integer>> queryNodes = queryFromFile(queryPath+aaa);
            ...
            for(int j=0; j<algorithms.length; j++)
            {
                ...
                for(int i=0; i<qns; i++)
                {
                    ...
                    */
                    ...
                    Set<Integer> solution = algorithm(bbb, graph, index, q, kkk[i]);
    ...
    private static Set<Integer> algorithm(String algorithm, GraphWithOrderedAdj graph,
                                          IndexInterface index, List<Integer> queryNodes, int k) {
